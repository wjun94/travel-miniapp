...
export default function ProfilePage() {
  ...
  return (
    <View className="min-h-screen bg-gradient-to-b from-[#FFF6F0] via-[#FCFBF7] to-[#FCFBF7] px-4 pt-2 pb-10 font-sans">
      <NavBar />
      ...
      <View className="grid grid-cols-4 text-center my-6 px-1">
        {[
          ...
          <View key={i} className="flex flex-col active:opacity-70">
            ...
            <Text className="text-xs text-gray-400 mt-1 font-medium">{stat.label}</Text>
          </View>
        ))}
      </View>
